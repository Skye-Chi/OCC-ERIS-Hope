	...
	if(!body)
		...
		switch(event_type)
			if(RESEARCH_BREAKTHROUGH)
				body = "A major breakthough in the field of [pick("phoron research","super-compressed materials","nano-augmentation","onispace research","volatile power manipulation")] \
