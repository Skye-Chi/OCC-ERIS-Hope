...
/obj/item/book/manual/anomaly_spectroscopy
	...
	dat = {"<html>
				...
				same! Why, look at the strides we're making in piercing the walls of onispace or our steadily improving ability to clarify and stabilise subspace emissions; it's
...
/obj/item/book/manual/anomaly_testing
	...
	dat = {"<html>
				...
				<br>
				By employing a patented semi-phased alloy with unique and fascinating onispace interaction properties, Ward's contraption is able to 'harvest' energy, store
...
/obj/item/book/manual/stasis
	...
	dat = {"<html>
				...
				It was in examining the effects of decelerated, onispace, high energy particles when transphased through onispace that the effects where primarily noticed.
				Due to exigent properties of that dimension, transphasing those particles capable of existing in onispace with high stability levels has the effect of bringing
