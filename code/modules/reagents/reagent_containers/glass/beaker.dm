...
/obj/item/reagent_containers/glass/beaker/onispace
	name = "onispace beaker"
	desc = "A onispace beaker, powered by experimental onispace technology."
	icon_state = "beakeronispace"
	label_icon_state = "label_beakeronispace"
	matter = list(MATERIAL_STEEL = 4, MATERIAL_PHORON = 1)
	volume = 300
	amount_per_transfer_from_this = 10
	possible_transfer_amounts = list(5,10,15,25,30,60,120,300)
	lid_icon_state = "lid_beakeronispace"
	spawn_blacklisted = TRUE
