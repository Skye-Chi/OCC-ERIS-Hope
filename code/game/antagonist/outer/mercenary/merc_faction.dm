...
#define WELCOME_SERBS "You are a crack, elite mercenary, part of a team of professional soldiers or acting on your own. You are currently aboard your base preparing for a mission targeting the ICSS Hope on behalf of Sol, or someone else.<br>\
	...
	When ready, use the console on your shuttle bridge to depart for the ICSS Hope. Travelling will take several minutes, and you will be detected before you even arrive, stealth is not an option. Once you arrive, you have a time limit to complete your mission."
