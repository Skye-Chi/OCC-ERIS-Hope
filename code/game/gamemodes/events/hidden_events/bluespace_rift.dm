...
/datum/storyevent/onispace_rift
	id = "onispace_rift"
	name = "onispace_rift"

	weight = 1

	event_type = /datum/event/onispace_rift
	event_pools = list(
...
/datum/event/onispace_rift/proc/prepare_event_areas(var/number)
