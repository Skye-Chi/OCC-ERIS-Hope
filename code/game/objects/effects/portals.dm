...
/obj/effect/portal/proc/teleport(atom/movable/M as mob|obj)
	...
	if (istype(M, /atom/movable))
		if(prob(failchance)) //oh dear a problem, put em in deep space
			...
			go_to_onispace(origin_turf, entropy_value, FALSE, M, get_destination(origin_turf), 0) ///You will appear adjacent to the beacon
...
/obj/effect/portal/proc/on_fail(atom/movable/M as mob|obj)
	...
	go_to_onispace(origin_turf, entropy_value, FALSE, M, locate(rand(5, world.maxx - 5), rand(5, world.maxy -5), 3), 0)
/*
...
/obj/effect/portal/unstable/on_fail(atom/movable/M as mob|obj)
	...
	go_to_onispace(origin_turf, entropy_value, FALSE, M, get_destination(get_turf(M)), 1)
...
/obj/effect/portal/wormhole/rift/New(loc, exit, msg_admins=TRUE)
	...
	deltimer(lifetime)
	if(msg_admins)
		message_admins("onispace rift created between [jumplink(src)] and [jumplink(src.target)] with [teleportations_left] teleportations left")
