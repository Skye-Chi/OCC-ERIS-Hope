/datum/job/ihc
	...
	description = "You are the head of the Cobalt Aegis Security division contracted to protect and serve aboard the ICSS Hope. The company contracting you out, Cobalt Aegis Security serves as both an internal security force, and as a guard for expeditions outwith the ship.<br>\
	<br>\
