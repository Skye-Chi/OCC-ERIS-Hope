...
Though this does not mean you have no home, as the ICSS Hope is your home. Whatever planet you may have came from a now distant memory.<br>\
You remember boarding the ICSS Hope sometime in your past, when it had a different purpose and a different captain.<br>\
