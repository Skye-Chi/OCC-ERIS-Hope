...
/obj/item/mecha_parts/part/phazon_torso
	...
	origin_tech = list(TECH_MATERIAL = 7, TECH_onispace = 7, TECH_DATA = 7, TECH_POWER = 7)
	matter = list(MATERIAL_STEEL = 35, MATERIAL_GLASS = 10, MATERIAL_PHORON = 20)

/obj/item/mecha_parts/part/phazon_head
	name = "Phazon Head"
	icon_state = "phazon_head"
	origin_tech = list(TECH_MATERIAL = 5, TECH_onispace = 2, TECH_MAGNET = 6, TECH_DATA = 6)
	matter = list(MATERIAL_STEEL = 15, MATERIAL_GLASS = 5, MATERIAL_PHORON = 10, MATERIAL_SILVER = 30)

/obj/item/mecha_parts/part/phazon_left_arm
	name = "Phazon Left Arm"
	icon_state = "phazon_l_arm"
	origin_tech = list(TECH_MATERIAL = 5, TECH_onispace = 2, TECH_MAGNET = 3)
...
/obj/item/mecha_parts/part/phazon_armor
	...
	origin_tech = list(TECH_MATERIAL = 5, TECH_onispace = 3, TECH_MAGNET = 3)
